...
namespace EntityFrameworkRK.Migrations
{
    ...
    [Migration("20200803161214_versao16")]
    partial class versao16
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkRK.Model.CategoriaComum", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CategoriaMercadoLivreId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CategoriaOberloId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CategoriaMercadoLivreId");

                    b.HasIndex("CategoriaOberloId");

                    b.ToTable("CategoriaComum");
                });
            ...
            modelBuilder.Entity("EntityFrameworkRK.Model.CategoriaComum", b =>
                {
                    b.HasOne("EntityFrameworkRK.Model.CategoriaML", "CategoriaMercadoLivre")
                        .WithMany()
                        .HasForeignKey("CategoriaMercadoLivreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrameworkRK.Model.Categoria", "CategoriaOberlo")
                        .WithMany()
                        .HasForeignKey("CategoriaOberloId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
